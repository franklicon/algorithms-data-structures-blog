  ...
  return (
    <div className="my-10 not-prose">
      <div className="border border-rule dark:border-graphite/60 rounded-lg p-6 lg:p-8 bg-paper dark:bg-graphite/20 brutal:rounded-none brutal:border-2 brutal:border-brutal-ink brutal:bg-brutal-paper brutal:shadow-brutal">
        ...
        {/* Status line */}
        <div className="mt-6 pt-4 border-t border-rule dark:border-graphite/60 flex justify-between font-mono text-[11px] uppercase tracking-[0.18em] text-ink/50 dark:text-paper/50 brutal:border-t-2 brutal:border-brutal-ink brutal:text-brutal-ink brutal:font-bold">
